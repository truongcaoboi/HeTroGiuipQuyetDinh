...
public class Kiemthu {
	public static void main(String args[]) throws SQLException {
		...
		danhsach=new Execute().taoDanhSach("1",danhsach,(double)0.9,(double)0.7,11);
		danhsach=new Execute().taoDanhSach("2",danhsach,(double)0.9,(double)0.7,10);
		danhsach=new Execute().taoDanhSach("3",danhsach,(double)0.9,(double)0.7,11);
